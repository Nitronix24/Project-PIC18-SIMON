...
; Dï¿½sactivation de la sortie PWM pour configuration ; Fixe la pï¿½riode de PWM
BSF       TRISC, 1 
MOVLW     0xFF
MOVWF     T2PR

; Configuration du module CCP2 et format des donnï¿½es
MOVLW     b'10001100'
MOVWF     CCP2CON                 
...
Tempo_0.5s:
    ...
    ; initialiser la valeur du timer ï¿½ 50036
    movlw   0xC3
    movwf   TMR0H		    ; maj TMR0H
...
Tempo_100us:
    ...
    ; initialiser la valeur du timer ï¿½ 65532
    movlw   0xFF
    movwf   TMR0H		    ; maj TMR0H
...
AddRandom:
    ...
    CLRF    FSR1L		    ; Rï¿½ninitialise le pointeur de lecture
    RETURN    
